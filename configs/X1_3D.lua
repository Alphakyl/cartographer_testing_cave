...
-- Trajectory Builder --
------------------------
MAX_3D_RANGE = 100.  --Kyle 100 --default 60. 
TRAJECTORY_BUILDER_3D.min_range = 0.8  --default 1.
...
POSE_GRAPH.constraint_builder.sampling_ratio = 0.05 --default 0.3     gene 0.03
-- POSE_GRAPH.constraint_builder.max_constraint_distance = 30 --default 15      gene 30
POSE_GRAPH.constraint_builder.min_score = 0.60  --default 0.55    gene 0.55         
